...
function setupSSE() {
    ...
    source.onmessage = function(event) {
        ...
        const replies = payload.replies.slice(-5); 
...
function triggerFinalSequence() {
    ...
    const thornGeometry = new THREE.TextGeometry(thornText, {
        font: font,
        size: 36,
        height: 1,
        curveSegments: 12,
    ...
    setTimeout(() => {
        ...
        flashBlackAndWhite(() => {
            const qGeometry = new THREE.TextGeometry(finalQuestion, {
                font: font,
                size: 30,
                height: 1,
                curveSegments: 12,
